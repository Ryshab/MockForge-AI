...
export const Route = createFileRoute("/mock-test")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "The CBT exam engine with palette, timers and section navigation lands in a future release.",
      },
  ...
  component: () => (
    <PageShell title="Mock test" description="The exam engine is not part of this foundation release.">
      <ComingSoon
        icon={MonitorPlay}
